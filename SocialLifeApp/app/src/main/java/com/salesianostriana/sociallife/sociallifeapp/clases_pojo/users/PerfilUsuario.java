...
public class PerfilUsuario {
     ...
     * @param biografia
     */
    public PerfilUsuario(Integer id, Integer usuario, String poblacion, String ciudad, String biografia, String foto) {
        this.id = id;
    ...
    public PerfilUsuario(Integer id, Integer usuario, String poblacion, String ciudad, String biografia, String ubicacion_actual, String foto) {
        this.id = id;
        this.usuario = usuario;
        this.poblacion = poblacion;
        this.ciudad = ciudad;
    ...
    public PerfilUsuario(String ubicacion_actual) {
        this.ubicacion_actual = ubicacion_actual;
    }
