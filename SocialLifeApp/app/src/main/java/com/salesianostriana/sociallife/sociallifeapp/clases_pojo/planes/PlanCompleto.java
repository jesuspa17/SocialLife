...
public class PlanCompleto{
     ...
     * @param foto
     */
    public PlanCompleto(Integer id, String titulo, String localizacion, String ciudad, String foto, String poblacion, String fecha, Categoria categoria, String descripcion, String coordenadas, UsuarioCompleto usuario) {
        this.id = id;
        this.titulo = titulo;
